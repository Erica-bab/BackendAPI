...
<td>식당 정보</td>
<td>code, name, address, building, floor, latitude, longitude, description</td>
</tr>
<tr>
...
| `GET` | `/api/v1/meals/restaurants/{restaurant_code}` | 식당 상세 정보 (위치 포함) |
...
| 코드 | 식당명 | 설명 |
|------|--------|------|
| `re11` | 교직원식당 | 복지관 3층 식당 |
| `re12` | 학생식당 | 복지관 2층 식당 |
| `re13` | 창의인재원식당 | 창의인재원 1층 식당 |
| `re15` | 창업보육센터 | 창업보육센터 지하 식당 |
